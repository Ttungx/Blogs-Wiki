...
export const BACKFILL_POLICIES: BackfillPolicy[] = [
  { sourceId: 'openai', mode: 'since', since: '2019-01-01', notes: '仅当前白名单分类（research/engineering/safety/security）' },
  { sourceId: 'anthropic', mode: 'since', since: '2019-01-01', notes: 'Research + Engineering 全量' },
  { sourceId: 'lilian-weng', mode: 'all' },
  { sourceId: 'langchain', mode: 'since', since: '2019-01-01', qualityFilter: true, notes: '白名单过滤后全量' },
  { sourceId: 'cursor', mode: 'since', since: '2019-01-01', notes: 'Research 分类全量' },
  { sourceId: 'qwen', mode: 'since', since: '2019-01-01' },
  { sourceId: 'google-deepmind', mode: 'since', since: '2019-01-01', qualityFilter: true, notes: 'technical blogs 全量 + broad 2020 起' },
  { sourceId: 'microsoft-research', mode: 'since', since: '2019-01-01', notes: 'handoff: since 2021；listing 无日期导致 policy 日期过滤误杀，改 all + 页面日期 integrity 把关' },
  { sourceId: 'meta-ai', mode: 'since', since: '2019-01-01', qualityFilter: true, notes: 'handoff: since 2020；listing 无日期导致 policy 日期过滤误杀，改 all + 页面日期 integrity 把关' },
  { sourceId: 'eleuther-ai', mode: 'since', since: '2019-01-01' },
  { sourceId: 'mistral-ai', mode: 'since', since: '2019-01-01', notes: 'Research + Engineering categories' },
  ...
  { sourceId: 'moonshot', mode: 'since', since: '2019-01-01' },
  { sourceId: 'github-engineering', mode: 'since', since: '2019-01-01' },
  { sourceId: 'google-security', mode: 'since', since: '2019-01-01' },
