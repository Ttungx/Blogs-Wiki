...
1. 🟨 在 GitHub 仓库配置 `OPENAI_API_KEY`、`OPENAI_BASE_URL`、`TRANSLATION_MODEL`、`CONTENT_SYNC_TOKEN` Secrets，以及 `CONTENT_SYNC_URL` Repository Variable
2. 🟨 运行一次非 dry-run Action，核验真实翻译、分片同步与线上 D1 文章数增长
...
- [x] 调整为 Cloudflare Worker + GitHub Actions 组合架构
