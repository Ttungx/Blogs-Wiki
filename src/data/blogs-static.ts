...
export const staticBlogs: StaticBlogEntry[] = [
  ...
  },
  {
    ...
    "data": {
      ...
      "type": "company",
      "description": "OpenAI 开发者平台的产品公告与工程实践（API、Codex、Agents 工作流）。",
  ...
  },
  {
    ...
    "data": {
      ...
      "type": "company",
      "author": "Qwen Team",
      "description": "阿里通义千问模型团队的官方研究博客，覆盖 LLM、多模态与 Agent（已迁移 qwen.ai/research）。",
      "homepageUrl": "https://qwen.ai/",
      "blogUrl": "https://qwen.ai/research",
      "domain": "qwen.ai",
